...
@section('content_header')
    <div class="container-fluid">
        <div class="row align-items-center mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('labels.notification.title.history') }} - {{$notificacao->titulo}}</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table-system table-bordered table-hover">
                <thead>
                    <tr>
                        <th class="whiteSpace-nowrap col-md-3">{{ __('labels.notification.history.table.date') }}</th>
                        <th class="whiteSpace-nowrap col-md-3">{{ __('labels.notification.history.table.user') }}</th>
                        <th class="whiteSpace-nowrap col-md-4">{{ __('labels.notification.history.table.type') }}</th>
                        <th class="whiteSpace-nowrap col-md-2 text-center">{{ __('labels.notification.history.table.actions') }}</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td class="whiteSpace-nowrap text-center">
                                <button type="button" class="detalhes btn btn-outline-info btn-sm"
                                        data-details-url="{{ URL::signedRoute('sistema.notificacao.history.details', ['notificacao' => $historico->notificacao->id, 'historico' => $historico->id]) }}"
