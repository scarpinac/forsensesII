    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table-system table-bordered table-hover">
                <thead>
                    <tr>
                        <th class="whiteSpace-nowrap col-md-3">{{ __('labels.access_level.history.table.date') }}</th>
                        <th class="whiteSpace-nowrap col-md-3">{{ __('labels.access_level.history.table.user') }}</th>
                        <th class="whiteSpace-nowrap col-md-4">{{ __('labels.access_level.history.table.type') }}</th>
                        <th class="whiteSpace-nowrap col-md-2 text-center">{{ __('labels.access_level.history.table.actions') }}</th>
                    </tr>
                </thead>
                <tbody>
