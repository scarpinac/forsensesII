...
@section('content_header')
    <div class="container-fluid">
        <div class="row align-items-center mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ __('labels.api.title.history') }} - {{$api->descricao}}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right mb-0">
                    ...
                    <li class="breadcrumb-item active">{{ __('labels.api.title.history') }}</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">{{ __('labels.api.history.data.title') }}</h3>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">{{ __('labels.api.history.changes.title') }}</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <div class="table-responsive">
            <table class="table-system table-bordered table-hover">
                <thead>
                    <tr>
                        <th class="whiteSpace-nowrap col-md-3">{{ __('labels.api.history.table.date') }}</th>
                        <th class="whiteSpace-nowrap col-md-3">{{ __('labels.api.history.table.user') }}</th>
                        <th class="whiteSpace-nowrap col-md-4">{{ __('labels.api.history.table.type') }}</th>
                        <th class="whiteSpace-nowrap col-md-2 text-center">{{ __('labels.api.history.table.actions') }}</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($api->historicos as $historico)
                        <tr>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center">{{ __('labels.api.no.history') }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailsModalLabel">{{ __('labels.api.modal.details.title') }}</h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('labels.api.modal.close') }}</button>
            </div>
        </div>
    </div>
</div>
