...
<div class="row">
    <div class="form-group col-md-12">
        ...
        <textarea name="mensagem" id="mensagem" class="form-control @error('mensagem') is-invalid @enderror" rows="5" data-tinymce data-placeholder="{{ __('labels.notification.mensagem_placeholder') }}">{{ old('mensagem', $notificacao->mensagem ?? '') }}</textarea>
        @error('mensagem')
            <div class="invalid-feedback font-weight-bold" role="alert">
                {{ $message }}
            </div>
