...
return new class extends Migration
{
    ...
    {
        $permissoes = [
            'cadastro.regra_desconto.index',
            'cadastro.regra_desconto.create',
            'cadastro.regra_desconto.edit',
            'cadastro.regra_desconto.destroy',
            'cadastro.regra_desconto.show',
            'cadastro.regra_desconto.history',
        ];
        ...
        DB::table('menu')->insert([
            [
                'descricao' => 'Regra de Desconto',
                'icone' => 'fas fa-tag',
                'rota' => 'cadastro.regra_desconto.index',
