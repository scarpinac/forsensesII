...
return new class extends Migration
{
    ...
    {
        $permissoes = [
            'cadastro.transportadora.index',
            'cadastro.transportadora.create',
            'cadastro.transportadora.edit',
            'cadastro.transportadora.destroy',
            'cadastro.transportadora.show',
            'cadastro.transportadora.history',
        ];
        ...
        DB::table('menu')->insert([
            [
                ...
                'icone' => 'fas fa-truck',
                'rota' => 'cadastro.transportadora.index',
