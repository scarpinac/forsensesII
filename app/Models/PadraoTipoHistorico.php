...
class PadraoTipoHistorico extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'padrao_tipo_historico';
    ...
    /**
     * Get the padraoTipo that owns the historico.
     */
    public function padraoTipo(): BelongsTo
    {
