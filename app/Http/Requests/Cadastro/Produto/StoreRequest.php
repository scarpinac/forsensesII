...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'descricao' => 'required|string|max:100|unique:produto,descricao,NULL,id,deleted_at,NULL',
            'codigo' => 'required|string|max:50|unique:produto,codigo,NULL,id,deleted_at,NULL',
