...
class StoreRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            'descontoInicial' => Tools::limparValor($this->valor),
            'descontoMaximo' => Tools::limparValor($this->valor),
            'descontoAtual' => Tools::limparValor($this->valor),
            'areaExposicao' => Tools::limparValor($this->valor),
        ]);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'cnpj' => 'required|string|size:14|unique:revenda,cnpj',
