...
class StoreRequest extends FormRequest
{
    ...
    {
        return Auth::user()->canAccess('cadastro.transportadora.store');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'cnpj' => 'required|string|size:14|unique:transportadora,cnpj',
            'situacao_id' => 'required|exists:padrao_tipo,id',
            'observacao' => 'nullable|string',
            'estadosAtendidos' => 'nullable|array',
            'estadosAtendidos.*' => 'string|size:2', // Estados como siglas de 2 letras
        ];
    }
