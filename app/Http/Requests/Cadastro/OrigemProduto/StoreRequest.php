...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'codigo' => 'required|string|max:3|unique:origem_produto,codigo,NULL,id,deleted_at,NULL',
            'descricao' => 'required|string|max:100|unique:origem_produto,descricao,NULL,id,deleted_at,NULL',
